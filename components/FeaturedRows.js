...
const FeaturedRows = () => {
  return (
    <View className="flex gap-6 pt-2">
      <Text className="h-1 font-bold text-xl px-1">Offers near you!</Text>
      <Text className="text-sm font-regular text-gray-400 flex px-1">Why not support your local restaurant tonight!</Text>
